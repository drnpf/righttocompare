  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] xl:max-w-[1400px] 2xl:max-w-[1600px] mx-auto px-6 py-8">
        ...
        <div id="overview" className="bg-white dark:bg-[#161b26] rounded-2xl shadow-sm p-8 mb-8 border border-[#e0e0e0] dark:border-[#2d3548]">
              ...
              <div className="relative inline-block">
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 rounded-xl bg-[#2c3968] dark:bg-[#4a7cf6] opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300"></div>
                    ...
                    <div className="absolute right-full mr-3 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-10">
                      <div className="bg-[#1e1e1e] dark:bg-[#252b3d] text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap shadow-lg">
                        Browse phone catalog
                        <div className="absolute left-full top-1/2 -translate-y-1/2 border-8 border-transparent border-l-[#1e1e1e] dark:border-l-[#252b3d]"></div>
                      </div>
                    </div>
                  </button>
                ...
                <Dialog open={isPriceAlertOpen} onOpenChange={setIsPriceAlertOpen}>
                  ...
                  <DialogContent className="sm:max-w-[425px] dark:bg-[#161b26] dark:border-[#2d3548]">
                    ...
                    <DialogFooter>
                      ...
                      <Button
                        type="submit"
                        className="bg-[#2c3968] dark:bg-[#4a7cf6] hover:bg-[#2c3968]/90 dark:hover:bg-[#4a7cf6]/90"
        ...
        <Collapsible open={isKeySpecsOpen} onOpenChange={setIsKeySpecsOpen}>
          <div id="key-specs" className="bg-white dark:bg-[#161b26] rounded-2xl shadow-sm p-8 mb-8 border border-[#e0e0e0] dark:border-[#2d3548]">
            <div className="mb-6">
              <div className="flex items-center gap-3">
                <div>
                      ...
                      {specGlossary[spec.label] && (
                        <TooltipProvider delayDuration={200}>
                          <Tooltip>
                            ...
                            <TooltipContent
                              side="bottom"
                              className="max-w-xs bg-white dark:bg-[#252b3d] text-[#1e1e1e] dark:text-white border-2 border-[#2c3968]/20 dark:border-[#4a7cf6]/20 shadow-xl px-4 py-3 rounded-xl"
                              sideOffset={8}
                            >
                              ...
                              <div className="flex items-start gap-1.5 bg-[#fffbeb] dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/30 rounded-lg px-2.5 py-1.5">
                                ...
                                <p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">{specGlossary[spec.label].tip}</p>
                              </div>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
        ...
        <Collapsible open={isPriceTrackingOpen} onOpenChange={setIsPriceTrackingOpen}>
          <div id="price-tracking" className="bg-white dark:bg-[#161b26] rounded-2xl shadow-sm p-8 mb-8 border border-[#e0e0e0] dark:border-[#2d3548]">
            <div className="mb-6">
              <div className="flex items-center gap-3">
                <div>
        ...
        <Collapsible open={isFilterOpen} onOpenChange={setIsFilterOpen}>
          <div id="filter-specs" className="bg-white dark:bg-[#161b26] rounded-2xl shadow-sm p-8 mb-8 border border-[#e0e0e0] dark:border-[#2d3548]">
                      ...
                      <div className="group border border-[#e0e0e0] dark:border-[#2d3548] rounded-lg hover:border-[#2c3968]/20 dark:hover:border-[#4a7cf6]/20 transition-all duration-200 bg-white dark:bg-[#161b26] relative">
                        <div className="flex items-center justify-between p-4 cursor-pointer hover:bg-[#f7f9fc] dark:hover:bg-[#1a1f2e] transition-colors duration-200">
                          <div className="flex items-center gap-3 flex-1">
                            ...
                            <div className="w-9 h-9 rounded-lg bg-[#f5f7fa] dark:bg-[#1a1f2e] flex items-center justify-center">
                          ...
                          <div className="absolute top-full left-0 right-0 z-50 border border-[#e0e0e0] dark:border-[#2d3548] rounded-lg bg-white dark:bg-[#161b26] shadow-lg mt-1">
                            <div className="bg-[#fafbfc] dark:bg-[#1a1f2e] p-4 space-y-1 max-h-[300px] overflow-y-auto">
                              {specs.map((specName) => (
                                <div
                                  key={specName}
                                  className="flex items-center gap-3 py-2 px-3 rounded-md hover:bg-white dark:hover:bg-[#252b3d] transition-colors duration-150"
                                >
                                  <Checkbox
                                    ...
                                    {specTooltips[specName] && (
                                      <TooltipProvider delayDuration={200}>
                                        <Tooltip>
                                          ...
                                          <TooltipContent
                                            side="right"
                                            className="max-w-sm bg-white dark:bg-[#252b3d] text-[#1e1e1e] dark:text-white border-2 border-[#2c3968]/20 dark:border-[#4a7cf6]/20 shadow-xl px-4 py-3 rounded-xl"
                                            sideOffset={8}
                                          >
        ...
        <Collapsible open={isFullSpecsOpen} onOpenChange={setIsFullSpecsOpen}>
          <Card id="full-specs" className="shadow-sm bg-white dark:bg-[#161b26] border-[#e0e0e0] dark:border-[#2d3548]">
            <CardHeader>
              <div className="mb-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 mt-3">
                          <div className="relative flex-1">
                            ...
                            <input
                              ...
                              className="w-full pl-9 pr-4 py-2 border border-[#e0e0e0] dark:border-[#2d3548] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2c3968]/30 dark:focus:ring-[#4a7cf6]/30 focus:border-[#2c3968] dark:focus:border-[#4a7cf6] dark:bg-[#1a1f2e] dark:text-white dark:placeholder:text-[#6b7280]"
                            />
                          </div>
                                    ...
                                    {entries.map(([name, entry]) => (
                                      ...
                                      >
                                        ...
                                        <div className="flex items-start gap-1.5 bg-[#fffbeb] dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/30 rounded-lg px-3 py-2">
                                          ...
                                          <p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">{entry.tip}</p>
                                        </div>
                                      </div>
                                    ))}
                                  </div>
                      ...
                      .map(([category, specs], categoryIdx) => {
                        ...
                        return (
                          <div key={category}>
                            ...
                            <div
                              id={`spec-${category}`}
                              className="bg-gradient-to-r from-[#2c3968]/5 dark:from-[#4a7cf6]/5 to-transparent border-l-4 border-[#2c3968] dark:border-[#4a7cf6] px-6 py-4 -mx-6 mb-6"
                            >
        ...
        <Collapsible open={isCarrierCompatOpen} onOpenChange={setIsCarrierCompatOpen}>
          <div id="carrier-compat" className="bg-white dark:bg-[#161b26] rounded-2xl shadow-sm p-8 mb-8 mt-8 border border-[#e0e0e0] dark:border-[#2d3548]">
            <div className="mb-6">
              <div className="flex items-center gap-3">
                <div>
                    ...
                    >
                      <div className="flex items-center gap-4 flex-1">
                        <div
                          className={`w-10 h-10 rounded-full flex items-center justify-center ${
                            carrier.compatible ? "bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400" : "bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400"
                          }`}
                        >
                          {carrier.compatible ? (
                      ...
                      <div
                        className={`px-3 py-1 rounded-full text-xs ${
                          carrier.compatible ? "bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400" : "bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400"
                        }`}
                      >
        ...
        <Collapsible open={isReviewsOpen} onOpenChange={setIsReviewsOpen}>
          <div id="reviews" ref={reviewsSectionRef} className="bg-white dark:bg-[#161b26] rounded-2xl shadow-sm p-8 mb-8 mt-8 border border-[#e0e0e0] dark:border-[#2d3548]">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
              ...
              <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                {!showReviewForm && (
                  <Button
                    className="bg-gradient-to-r from-[#2c3968] to-[#3d4b7f] dark:from-[#4a7cf6] dark:to-[#5b8df7] hover:from-[#2c3968]/90 hover:to-[#3d4b7f]/90 shadow-md hover:shadow-lg transition-all"
                ...
                <div className="mb-6">
                  {!currentUser ? (
                    <div className="bg-[#f7f7f7] dark:bg-[#1a1f2e] border-2 border-[#2c3968] dark:border-[#4a7cf6] rounded-lg p-6 text-center">
                      ...
                      <Button className="bg-[#2c3968] dark:bg-[#4a7cf6] hover:bg-[#2c3968]/90 dark:hover:bg-[#4a7cf6]/90">Sign In</Button>
                    </div>
                  ) : (
                    <ReviewForm
