...
import { phonesData } from "../data/phoneData"; // REMOVE LATER MOCK DATA
...
const specTooltips: Record<string, string> = {
  // Display
  "Screen Size":
    'The diagonal measurement of the display. Larger screens (6.5"+ are better for media and gaming, while smaller screens are more portable.',
  Resolution:
    "The number of pixels on the screen. Higher resolution means sharper text and images. QHD+ (1440p) is sharper than FHD+ (1080p).",
  Technology:
    "The display panel type. AMOLED/OLED offer perfect blacks and vibrant colors, while LCD is more affordable but less contrast-rich.",
  "Refresh Rate":
  ...
  "Peak Brightness":
    "The maximum brightness level the screen can reach, measured in nits. Higher values (1500+ nits) mean better visibility in direct sunlight.",
  Protection:
    "The type of protective glass covering the screen. Gorilla Glass and Ceramic Shield protect against scratches and drops.",
  "Pixel Density":
    "Pixels per inch (ppi). Higher values mean sharper displays. Anything above 400 ppi is very sharp and difficult to distinguish individual pixels.",
  "Screen-to-Body Ratio":
    "The percentage of the front that's actually screen. Higher percentages (85%+) mean smaller bezels and more immersive viewing.",

  // Performance
  Processor:
    "The main chip that powers the phone. Think of it as the 'brain' that handles all computing tasks and determines overall performance.",
  Chipset:
  ...
  Storage:
    "Internal storage capacity for apps, photos, and files. More storage (256GB+) means you can store more content without running out of space.",
  "Expandable Storage":
    "Whether you can add a microSD card for additional storage. Most flagship phones no longer support expandable storage.",
  "Operating System":
    "The software platform that runs the phone. Android and iOS are the two main options, each with their own app ecosystems.",
  Upgradability:
    "How long the manufacturer promises to provide software updates. Longer support (4+ years) means your phone stays secure and gets new features longer.",

  // Benchmarks
  "AnTuTu v10":
    "Overall performance benchmark measuring CPU, GPU, memory, and UX. Scores above 1 million are flagship-level performance.",
  "AnTuTu Score":
    "Overall performance benchmark. Higher scores indicate faster, more powerful devices. Scores above 1 million are considered flagship-level.",
  "GeekBench 6 Single-Core":
    "Measures single-threaded CPU performance for everyday tasks like browsing and scrolling. Higher is better.",
  "GeekBench 6 Multi-Core":
    "Measures multi-threaded CPU performance for demanding tasks like video editing. Higher scores mean better multitasking.",
  "Geekbench Score":
    "Measures CPU performance in real-world tasks. Single-core shows performance for everyday tasks, multi-core shows performance under heavy load.",
  "3DMark Wild Life Extreme":
    "Graphics benchmark for gaming performance. Higher scores indicate better gaming capabilities with smoother framerates.",
  "3DMark Solar Bay":
    "Ray tracing graphics benchmark. Tests advanced graphics capabilities for the most demanding mobile games.",
  "GFXBench Manhattan 3.1":
    "GPU benchmark measuring graphics performance. Higher fps means smoother gaming and better 3D performance.",
  "GFXBench Car Chase":
    "Advanced GPU benchmark. Tests sustained graphics performance under heavy load. Higher fps is better for gaming.",
  "PCMark Work 3.0":
    "Measures real-world productivity performance including web browsing, video editing, and photo editing.",

  // Camera
  "Main Camera":
    "The primary rear camera. MP = megapixels (resolution), f-number = aperture (lower is better for low light), OIS = optical stabilization.",
  "Periscope Telephoto":
    "A telephoto camera using periscope lens technology for high-quality optical zoom, typically 5x or more.",
  Telephoto:
    "A zoom camera that uses optical lenses to magnify subjects without quality loss. Higher MP and optical zoom values are better.",
  "Ultra Wide":
    "A camera with a wide field of view (usually 120°) for landscape and group photos. Good for fitting more into the frame.",
  "Front Camera":
    "The selfie camera. Higher MP means more detail, but good low-light performance and wider angles also matter.",
  "Video Recording":
    "Maximum video resolution and framerate. 4K@60fps is ideal for high-quality videos, 8K for future-proofing.",
  "Camera Features":
    "Additional camera capabilities like HDR (better dynamic range), night mode, and stabilization features.",
  Aperture:
  ...
  // Battery
  Capacity:
    "Battery size in milliampere-hours (mAh). Larger capacity (4500+ mAh) generally means longer battery life, though efficiency also matters.",
  Charging: "Fast charging wattage for wired charging. Higher wattage (45W+) means faster charging times from 0-100%.",
  "Wireless Charging":
    "Charges your phone by placing it on a charging pad without cables. Typically 15W or less, slower than wired but convenient.",
  "Reverse Wireless":
    "Allows your phone to wirelessly charge other devices (like earbuds) by placing them on the back of the phone.",
  "Charging Time": "How long it takes to charge the battery to a certain percentage. Faster is better for convenience.",
  "Battery Type":
    "The chemistry of the battery. Li-Ion and Li-Po are standard. Non-removable means you can't easily replace it yourself.",

  // Design
  Dimensions:
    "Physical size of the phone in millimeters (height x width x thickness). Larger phones have bigger screens but are less pocketable.",
  Weight:
    "How heavy the phone is in grams. Lighter phones (under 200g) are more comfortable to hold for extended periods.",
  Materials:
    "What the phone is made of. Premium materials like titanium, aluminum, and glass feel better but may be more fragile than plastic.",
  Colors: "Available color options for the phone body. Choice is purely aesthetic preference.",
  "Water Resistance":
    "IP rating for water protection. IP68 means safe in up to 1.5m of water for 30 minutes. Higher numbers are better.",
  "Dust Resistance":
    "IP rating for dust protection. IP6X means completely dust-tight, protecting internal components from particles.",
  "IP68 Rating":
  ...
  "S Pen":
    "Samsung's stylus for Galaxy Note and Ultra series. Enables precise input for drawing, note-taking, and navigation.",
  ...
  "Wi-Fi":
    "Wireless internet connectivity standard. Wi-Fi 6/6E/7 offer faster speeds and better performance in crowded areas than older standards.",
  "Wi-Fi 6E":
    "Latest Wi-Fi standard offering faster speeds and less interference than older versions. Requires a compatible router to take full advantage.",
  Bluetooth:
    "Wireless technology for connecting accessories like headphones and speakers. Version 5.0+ offers better range and stability.",
  ...
  // Audio
  Speakers:
    "Built-in speakers for calls, media, and alerts. Stereo (two speakers) provides better sound than mono (one speaker).",
  "3.5mm Jack": "Traditional headphone port. Most modern phones have removed this in favor of wireless or USB-C audio.",
  "Audio Features":
    "Additional audio capabilities like spatial audio, hi-res codec support, and audio tuning by premium brands.",
  "Hi-Res Audio":
    "Support for high-resolution audio formats that preserve more detail than standard MP3. Requires compatible headphones to benefit.",

  // Sensors
  Fingerprint:
    "Biometric sensor for unlocking. Ultrasonic is more secure and works when wet, optical is faster, side-mounted is very convenient.",
  "Face Unlock":
    "Uses front camera to recognize your face for unlocking. 3D systems (like Face ID) are more secure than 2D camera-based systems.",
  ...
  Proximity:
    "Detects when the phone is near your face during calls to turn off the screen and prevent accidental touches.",
...
// Phone Spec Page implmenetation
