...
const retailerLogoData: Record<string, string> = {
  ...
  `),
  "Best Buy": "data:image/svg+xml;utf8," + encodeURIComponent(`
    <svg xmlns="http://www.w3.org/2000/svg" width="120" height="40" viewBox="0 0 120 40">
  ...
  `),
  Walmart: "data:image/svg+xml;utf8," + encodeURIComponent(`
    <svg xmlns="http://www.w3.org/2000/svg" width="120" height="40" viewBox="0 0 120 40">
                ...
                <DialogContent className="w-full max-w-[min(92vw,48rem)] rounded-2xl border-[#2c3968]/15 p-5 sm:p-6">
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <section className="rounded-2xl border border-[#2c3968]/10 bg-white p-4">
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-[#666]">Open Amazon searches for accessories that fit this phone.</p>
                      </div>
                        <div className="flex flex-col gap-3">
                  ...
                  <DialogFooter className="mt-4 sm:justify-start">
                    <p className="text-xs text-[#666]">
                      Each button opens one search in a new tab.
                    </p>
                  </DialogFooter>
                </DialogContent>
              </Dialog>
