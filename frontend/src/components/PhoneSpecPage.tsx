            ...
            <CollapsibleContent>
              <CarrierCompatibilityChecker
                ...
                networkBands={phoneData.categories?.connectivity ? {
                  bands4G: phoneData.categories.connectivity["4G Bands"]?.split(",").map((b: string) => b.trim()) || [],
                  bands5G: phoneData.categories.connectivity["5G Bands"]?.split(",").map((b: string) => b.trim()) || [],
                } : undefined}
              />
            </CollapsibleContent>
          </div>
